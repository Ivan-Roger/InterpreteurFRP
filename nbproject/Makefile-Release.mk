...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/interpreteur_frp

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/interpreteur_frp: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/interpreteur_frp ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${TESTDIR}/TestFiles/f1: ${TESTDIR}/tests/newtestrunner1.o ${TESTDIR}/tests/testSi_class.o ${OBJECTFILES:%.o=%_nomain.o}
...
${TESTDIR}/tests/testSi_class.o: tests/testSi_class.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testSi_class.o tests/testSi_class.cpp
...
${OBJECTDIR}/TableProcedures_nomain.o: ${OBJECTDIR}/TableProcedures.o TableProcedures.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TableProcedures_nomain.o TableProcedures.cpp;\
	else  \
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/interpreteur_frp
